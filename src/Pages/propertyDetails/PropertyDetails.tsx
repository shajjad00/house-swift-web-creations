...
const PropertyDetails: React.FC = () => {
  const [propertyRecommendation, setPropertyRecommendation] = useState([]);
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  useEffect(() => {
    axiosPublic
      .get(
        `/propertyRecommendation?name=${name}&bedroom=${bedroom}&district=${district}`
      )
      .then((res) => {
        setPropertyRecommendation(res.data.data);
      });
  }, [axiosPublic, bedroom, district, name]);
  console.log(propertyRecommendation);
        ...
        <div className="max-w-7xl mx-auto mt-20 my-8 md:px-20 py-8">
          ...
          <div className="flex gap-10">
            <div className="flex flex-col justify-center gap-8">
              <div
                // style={{ height: "560px" }}
                className="w-full  bg-white border h-fit border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700"
              >
                <div>
                  <img
          ...
          <div className="shadow rounded-lg my-2  mx-auto w-full">
          ...
          <h2 className="text-3xl text-center font-bold pb-4 my-12">
            Related Property
          </h2>
          <div className=" grid grid-cols-1 lg:grid-cols-3 gap-5 md:grid-cols-2">
            {propertyRecommendation.map(
              (property: {
                _id: string;
                name: string;
                upazila: string;
