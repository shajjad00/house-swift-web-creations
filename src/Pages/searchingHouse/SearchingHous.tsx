...
const SearchingHous = ({ searching }: SearchgingProps) => {
    const { name, location, image, rent_price, available_quantity, bedroom, bathroom, area ,agent_name , agent_image} = searching || {};
    return (
        <>
        <motion.div
