  ...
  return (
    <div>
      ...
      <section className="pt-32 pb-32 relative">
        ...
        <h1 className="text-white uppercase text-3xl text-center relative">
          About Us
        </h1>
        <h1 className=" py-3 text-white text-center relative">
          {" "}
  ...
  <div className="py-8 px-4 mx-auto max-w-7xl lg:py-16 md:px-16 ">
      ...
      <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
          <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              <a href="#">
                  <img className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src="http://themeearth.com/tf/html/rentalplace/img/tm.jpg" alt="Bonnie Avatar"/>
              </a>
              <div className="p-5">
                  <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                      <a href="#">Elizabeth</a>
                  </h3>
                  <span className="text-gray-500 dark:text-gray-400">Appertment Sell</span>
          ...
          <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              <a href="#">
                  <img className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src="http://themeearth.com/tf/html/rentalplace/img/tm2.jpg" alt="Jese Avatar"/>
              </a>
              <div className="p-5">
                  <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                      <a href="#">Gabriella</a>
                  </h3>
                  <span className="text-gray-500 dark:text-gray-400">House Rent</span>
          ...
          <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              <a href="#">
                  <img className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src="http://themeearth.com/tf/html/rentalplace/img/tm3.jpg" alt="Michael Avatar"/>
              </a>
              <div className="p-5">
                  <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                      <a href="#">Michael Gough</a>
                  </h3>
                  <span className="text-gray-500 dark:text-gray-400">Appertment Management</span>
          ...
          <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              <a href="#">
                  <img className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src="http://themeearth.com/tf/html/rentalplace/img/tm4.jpg" alt="Sofia Avatar"/>
              </a>
              <div className="p-5">
                  <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                      <a href="#">Mackenzie</a>
                  </h3>
                  <span className="text-gray-500 dark:text-gray-400">Find An Agents</span>
