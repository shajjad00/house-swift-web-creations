            ...
            <div className="max-w-7xl mx-auto px-4 md:px-20 flex justify-start w-full">
              <div className="text-white space-y-5 w-full">
                <h2 className="text-3xl md:text-5xl font-bold">
                  <span className="text-[#fca129]"> Good </span>Service is <br /> our
                  passion
                </h2>
                <p>
                  No matter what the weather, no matter what the situation we are
                  in, if we have <br /> the right perspective in life, life will always
                  be beautiful!
                </p>
            ...
            <div className="max-w-7xl mx-auto px-4 md:px-20 flex justify-start w-full">
              <div className="text-white space-y-5 w-full">
                ...
                <p>
                  ...
                  secrets, drawing readers into a realm where shadows <br /> intertwine
            ...
            <div className="max-w-7xl mx-auto px-4 md:px-20 flex justify-start w-full">
              <div className="text-white space-y-5 w-full">
                ...
                <p>
                  ...
                  realms. Readers brave <br /> its pages, unlocking mysteries that blur
            ...
            <div className="max-w-7xl mx-auto px-4 md:px-20 flex justify-start w-full">
              <div className="text-white space-y-5 w-full">
                ...
                <p>
                  ...
                  exploring diverse lives, love, and challenges. <br /> Through vivid
